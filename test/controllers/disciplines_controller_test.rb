...
class DisciplinesControllerTest < ActionController::TestCase
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post :create, discipline: { description: @discipline.description, location: @discipline.location, title: @discipline.title }
    end
  ...
  test "should update discipline" do
    patch :update, id: @discipline, discipline: { description: @discipline.description, location: @discipline.location, title: @discipline.title }
    assert_redirected_to discipline_path(assigns(:discipline))
  end
