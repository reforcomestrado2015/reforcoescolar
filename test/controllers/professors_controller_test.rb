...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { cep: @professor.cep, cidade: @professor.cidade, cpf: @professor.cpf, email: @professor.email, fone1: @professor.fone1, fone2: @professor.fone2, login: @professor.login, logradouro: @professor.logradouro, nome: @professor.nome, qtdpontos: @professor.qtdpontos, qtdvotos: @professor.qtdvotos, senha: @professor.senha, uf: @professor.uf, valorHoraAula: @professor.valorHoraAula }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { cep: @professor.cep, cidade: @professor.cidade, cpf: @professor.cpf, email: @professor.email, fone1: @professor.fone1, fone2: @professor.fone2, login: @professor.login, logradouro: @professor.logradouro, nome: @professor.nome, qtdpontos: @professor.qtdpontos, qtdvotos: @professor.qtdvotos, senha: @professor.senha, uf: @professor.uf, valorHoraAula: @professor.valorHoraAula }
    assert_redirected_to professor_path(assigns(:professor))
  end
